...
public class Robot implements iFight, iMove {
    ...
    public Robot(String name, int mightOfGun, int rangeOfGunAttack, int meleemight, int initiativa, int armor, int radiator, int maxWeght, int gunSockets, int rocketSockets, int laserSockets, int maxNumberOfMoves, int maxLeftHandSlots, int maxRightHandSlots) {
        this.name = name; this.mightOfGun = mightOfGun; this.rangeOfGunAttack = rangeOfGunAttack; this.meleemight = meleemight; this.maxNumberOfMoves = maxNumberOfMoves; this.numberOfMoves = maxNumberOfMoves; this.initiativa = initiativa; this.armor = armor;      this.radiator = radiator;
        this.maxWeigth = maxWeght; this.laserSockets = laserSockets; this.gunSockets = gunSockets; this.rocketSockets = rocketSockets; this.maxLeftHandSlots = maxLeftHandSlots; this.maxRightHandSlots = maxRightHandSlots;
        this.headArmor = armor/4;   this.bodyArmor = armor/2;  this.handsArmor = armor/4; this.legsArmor = armor/3;
    }
